    ...
    <div class="row" style="max-width: 100%; max-height: 100%;">
        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img class="img1" src="./img/foto.jpg" alt="Imagen2">
            </div>
            <div class="carousel-item">
              <img class="img1" src="./img/restauracion.jpg" alt="Imagen3">
            </div>
          </div>
        </div>
      </div>
      <div class="col-7 mb-3" >
        <div class="row" style="background-color: white; border:1px white solid; border-radius:0 30px 0 0;">
          <div class="col-4">
            <img class="img2" src="../public/img/logo2.png" alt="Logo/Encrym">
          </div>
          <div class="col-1">
            <br>
        ...
        <div class="row" style="background-color: #F5F5F5;">
          ...
          <div class="col-12"><h2>Registro de horas</h2></div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-5">
                <a style="border: none; color:#FB7D0C; background-color: #F5F5F5;  text-decoration:double" href="/InicioRh" use:link>Iniciar Sesion(Recursos Humanos)</a>
              </div>
            </div>
            <!-- <div class="col-12"><br></div> -->
            <div class="col-12">
            ...
            <div class="col-12"><br></div>
            <div class="col-12">
              <button style="background-color: #FB7D0C; color: white; pading: 20px; font-size:20px" on:click={()=>verifica()}>Registrar Hora</button>
            </div>
            </div>
        </div>
      </div>
